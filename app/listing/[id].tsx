import { View, Text ,StyleSheet, Dimensions, Image, TouchableOpacity, ScrollView, Share } from 'react-native'
...
const Page = () => {
    ...
    const listing:any = (listingsData as any[]).find((item) =>item.id === id);
    ...
    const shareListing = async () => {
      try {
        await Share.share({
          title: listing.name,
          message: `Check out this listing: ${listing.listing_url}`, // Use message for Android
          url: listing.listing_url, // This works on iOS
        });
      } catch (err) {
